package com.baoyun.subsystems.cgf.constants;
...
public class Constants {
	...
	// CDR response中必选的消息，可能以后会用到
	public static final short GTP_PRIME_IET_DATA_RECORD_REQUESTS_RESPONDED = 253;
	...
	public static final int GTP_PORT = 3386;
