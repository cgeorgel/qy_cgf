...
public class GtpPrimeHeader {
	...
	private void initDefaults() {
		version = 2;
		pt = Constants.GTP_PRIME_PROTOCOL_TYPE;
		length = 0;
		messageType = Constants.GTP_PRIME_ECHO_REQUEST;
		sequenceNumber = 0;
	}
	...
	public void decodeFromMessage(byte[] message) throws UnrecognizedMessageException {
		...
		if (pt != Constants.GTP_PRIME_PROTOCOL_TYPE) throw new UnrecognizedMessageException("Message is not of type GTP' : ProtocolType field is not GTP'");
