...
public class SgwCdrReceivingStateHandler extends SgwSustainableStateHandler {


	private static Logger log = LoggerFactory.getLogger(SgwCdrReceivingStateHandler.class);

	public SgwCdrReceivingStateHandler(SgwCdrMergerContext context) {

		super(context);
		theState = SgwCdrMergerState.RECEIVING;
	}
